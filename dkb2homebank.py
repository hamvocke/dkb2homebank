...
class CsvFileTypes(Enum):
    UNKNOWN = 0     # We failed to auto-detect the csv file's format
    CASH = 1        # "Cash" account reports, generated by the pre-2023 web portal (ISO-8859-1)
    OLD_VISA = 2    # "Visa" account reports, generated by the pre-2023 web portal (ISO-8859-1)
    GIRO = 3        # "Giro" and "Tagesgeld" account reports, generated by the new (2023) web portal (UTF-8-sig)
    NEW_VISA = 4    # "Visa" account reports, generated by the new (2023) web portal (UTF-8-sig)
